      ...
      content: (
        <div>
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-lg font-semibold text-[#AEFF00]">Definir</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div className="bg-white p-4 rounded-lg shadow-md">
              <h4 className="font-semibold text-black mb-2">Estratégia</h4>
              <p className="text-xs md:text-sm text-gray-600">Análise e definição da estratégia de mercado e de negócios.</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow-md">
              <h4 className="font-semibold text-black mb-2">Tecnologia</h4>
              <p className="text-xs md:text-sm text-gray-600">Análise e definição da arquitetura e tecnologias necessárias.</p>
            </div>
            {/* <div className="bg-white p-4 rounded-lg shadow-md">
              <h4 className="font-semibold text-black mb-2">Gestão e Governança</h4>
              <p className="text-xs md:text-sm text-gray-600">Elaboração do roteiro de execução e gestão eficiente do projeto.</p>
            </div> */}
          </div>
        </div>
      ),
      ...
      content: (
        <div>
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-lg font-semibold text-[#AEFF00]">Desenvolver</h3>
          </div>
      ...
      content: (
        <div>
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-lg font-semibold text-[#AEFF00]">Evolução/otimização</h3>
          </div>
          <p className="text-white dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
          ...
          <div className="mb-8">
            <div className="flex gap-2 items-center text-white dark:text-neutral-300 text-xs md:text-sm mb-2">
            {/* <Image
                src="/check.svg"
                alt="Check"
                width={16}
